(function ($) {
  ...
  */
  ...
  var whatsappBtn = ".whatsappFloat";

  function getHomeHeroHalfwayTrigger() {
    var triggerPoint = 800;
    var $heroSlider = $(".hero-layout1");
    if ($heroSlider.length) {
      triggerPoint = $heroSlider.offset().top + ($heroSlider.outerHeight() / 2);
    }
    return triggerPoint;
  }
  ...
  function stickyMenu($targetMenu, $toggleClass, $parentClass) {
    ...
    var triggerPoint = getHomeHeroHalfwayTrigger();
  ...
  $(window).on("scroll", function () {
    var stickyTrigger = getHomeHeroHalfwayTrigger();
    ...
    // Show WhatsApp button after halfway down homepage hero slider.
